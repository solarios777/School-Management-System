      ...
      <form onSubmit={handleSubmit}>
        <div className="mb-4">
          ...
          <select
            className={`shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline ${
              formData.schoolType === "" && "border-red-500"
            }`}
            id="schoolType"
            name="schoolType"
        ...
        <div className="mb-4">
          ...
          <input
            ...
            type="text"
            placeholder="Enter Class Assignment"
        ...
        <div className="mb-4">
          ...
          <input
            ...
            type="text"
            placeholder="Enter Subjects Enrolled (comma-separated)"
            value={formData.subjectsEnrolled.join(", ")}
            onChange={(e) =>
              setFormData({
                ...formData,
                subjectsEnrolled: e.target.value
                  .split(",")
                  .map((s) => s.trim()),
              })
            }
        ...
        <div className="mb-4">
          ...
          <input
            ...
            type="text"
            placeholder="Enter Extracurricular Activities (comma-separated)"
        ...
        <div className="mb-4">
          ...
          <textarea
            ...
            rows={3}
            placeholder="Enter Disciplinary Records"
